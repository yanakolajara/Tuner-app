  ...
  return (
    <main>
      <div id='oneSong'>
        ...
        <h2 id='oneSongAlbum'>
          {data.name} is a song with {data.time} minutes long by the artist/band{' '}
          {data.artist}. This song appears on the album "{data.album}."
        </h2>
        <button id='oneSongBackButton' onClick={() => backButton()}>
          <img src={backArrow} />
        </button>
        <button id='oneSongEditButton' onClick={() => editButton()}>
          <img src={edit} />
        </button>
        <button id='oneSongRemoveButton' onClick={() => removeButton()}>
          <img src={remove} />
        </button>
      </div>
    </main>
